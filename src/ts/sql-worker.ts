class SqlWorkerInside {
    ...
    async initSQLite() {
        ...
        this.sqlite3 = await (self as any).sqlite3InitModule({
            print: (...args: any[]) => this.log(...args),
            printErr: (...args: any[]) => this.error(...args),
        });
    ...
    logHtml(cssClass : string, ...args: any[]): void {
        postMessage({
            type: 'log',
